...
<div class="navbar pt12 pb12" style="background:#2c2c2c;color: #fff">
    <div class="navbar-inner" style="width: 1000px;margin: auto;">
        ...
        <?php if(Think.session.userInfo.role == 1): ?><a class="active ml20" href="<?php echo U('Home/Index/index');?>">用户列表</a><?php endif; ?>
...
<div class="wrapper">
    <div style="width: 300px;margin: auto;" class="pt30">
