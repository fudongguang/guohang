...
util.parse = function (e) {
    ...
    var o = e.className.split(" "), i = o.indexOf(t);
    -1 != i && (o.splice(i, 1), e.className = o.join(" "))
...
util.addEventListener = function (e, t, o, i) {
    ...
    for (var e = window.location.search.substring(1), t = e.split("&"), o = {}, i = 0, n = t.length; n > i; i++) {
        var r = t[i].split("=");
        if (2 == r.length) {
            var a = decodeURIComponent(r[0]), l = decodeURIComponent(r[1]);
            o[a] = l
        }
    }
    return o
...
FileRetriever.prototype._hide = function (e) {
    ...
    if (r)this.prompt({title: "Open file", titleSubmit: "Open", description: "Select a file on your computer.", inputType: "file", inputName: "file", callback: function (e, t) {
        if (e) {
            if (r) {
        ...
        }, document.body.appendChild(l), this.prompt({title: "Open file", titleSubmit: "Open", description: "Select a file on your computer.", inputType: "file", inputName: "file", formAction: this.scriptUrl, formMethod: "POST", formTarget: a, callback: function (e) {
            e && i()
        }})
    }
}, FileRetriever.prototype.loadUrlDialog = function (e) {
    var t = this;
    this.prompt({title: "Open url", titleSubmit: "Open", description: "Enter a public url. Urls which need authentication or are located on an intranet cannot be loaded.", inputType: "text", inputName: "url", inputDefault: this.getUrl(), callback: function (o) {
        o ? t.loadUrl(o, e) : e()
    }})
    ...
    if (!t) {
        var o = 500, i = 5, n = document.body.offsetWidth || window.innerWidth;
    ...
    var r = e.type || "notification", a = e.closeButton !== !1, l = document.createElement("div");
...
app.CodeToTree = function () {
    ...
    try {
        ...
        try {
            ...
            console && console.log && console.log(c), alert(c)
        }
    }
    ...
    var t = e.toString().replace(/</g, "&lt;").replace(/>/g, "&gt;"), o = '<pre class="error">' + t + "</pre>";
    return"undefined" != typeof jsonlint && (o += '<a class="error" href="http://zaach.github.com/jsonlint/" target="_blank">validated by jsonlint</a>'), o
}, app.clearFile = function () {
    var e = {};
    codeEditor.set(e), treeEditor.set(e)
}, app.resize = function () {
    var e = document.getElementById("menu"), t = document.getElementById("treeEditor"), o = document.getElementById("codeEditor"), i = document.getElementById("splitter"), n = document.getElementById("buttons"), r = document.getElementById("drag"), a = document.getElementById("ad"), l = 15, s = window.innerWidth || document.body.offsetWidth || document.documentElement.offsetWidth, d = a ? a.clientWidth : 0;
    if (d && (s -= d + l), app.splitter) {
        ...
        } else h = s * p - f, r.innerHTML = "&lsaquo;", r.title = "Drag left to show the tree editor"; else h = 0, r.innerHTML = "&rsaquo;", r.title = "Drag right to show the code editor";
        o.style.display = 0 == p ? "none" : "", o.style.width = Math.max(Math.round(h), 0) + "px", codeEditor.resize(), r.style.height = i.clientHeight - n.clientHeight - 2 * l - (m ? l : 0) + "px", r.style.lineHeight = r.style.height, t.style.display = 1 == p ? "none" : "", t.style.left = Math.round(h + f) + "px", t.style.width = Math.max(Math.round(s - h - f - 2), 0) + "px"
    }
